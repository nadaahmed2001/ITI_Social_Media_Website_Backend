...
from .views import RegisterStudentView, LoginView, LogoutView, UserProfileView, AllProfilesAPI, UserProfileAPI, SkillAPI, PasswordResetRequestView,  PasswordResetConfirmView
